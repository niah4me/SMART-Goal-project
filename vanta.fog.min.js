...
//media queries
// Detect screen size changes using matchMedia
const mq = window.matchMedia("(max-width: 768px)");

function handleWidthChange(e) {
  if (e.matches) {
    console.log("Viewport is 768px or smaller");
    // Apply styles or logic for small screens
    document.body.style.backgroundColor = "#f0f0f0";
  } else {
    console.log("Viewport is wider than 768px");
    // Apply styles or logic for larger screens
...
// Detect screen size changes using window.innerWidth
